  ...
  methods: {
	 insertuser: {
      POST: function( context, connection ){
        ...
        var gender = connection.data.gender;
        var age = connection.data.age;
        social_users.insert({username:username, gender:gender, age:age})
    		API.utility.response( context, 300, {  "message": "Insert post ok!" } );
	...
	test: {
		POST: function( context, connection ){
			//insert data
			API.utility.response( context, 200, { "message": "Test API successfully!" } );
		}
	},
    pizza: {
